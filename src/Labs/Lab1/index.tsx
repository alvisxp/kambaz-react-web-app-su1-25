    ...
    return (
        <div id = "wd-lab1">
            ...
            <div id = "wd-lists">
                ...
                My favorite recipe - How to make fried rice:
                <ol id = "wd-fried-rice">
                    <li>Cook rice.</li>
                    <li>Heat oil in a pan.</li>
                    <li>Add spring onions, green chilies and protein.</li>
                    <li>Add cooked rice and soy sauce.</li>
                    <li>Stir-fry until heated through.</li>
                    <li>Serve hot.</li>
                </ol>
            ...
            <div id = "wd-images">
                ...
                <img 
                    id = "wd-starship" width = "400px"
                    src = "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/SpaceX_Starship_ignition_during_IFT-5.jpg/250px-SpaceX_Starship_ignition_during_IFT-5.jpg"
                />
                <br />
                Loading an image from the local file system: <br />
            ...
            <div id = "wd-forms">
                ...
                <form id = "wd-text-fields">
                    ...
                    <input type="text" placeholder = "Doe" value = "Wonderland" title = "The last name" 
                ...
                <label htmlFor="wd-radio-scifi">Sci-fi</label>
                <br />
                ...
                <label htmlFor="wd-chkbox-scifi">Sci-Fi</label>
                <br />
                <input type="checkbox" name="check-genre" id="wd-chkbox-fantasy" />
                <label htmlFor="wd-chkbox-fantasy">Fantasy</label>
                <h4 id = "wd-dropdown">Dropdowns</h4>
                <h5>Select one</h5>
                <label htmlFor="wd-select-one-genre">Favourite movie genre:</label>
                <br />
                ...
                <h5>Select many</h5>
                <label htmlFor="wd-select-many-genre">Favourite movie genres:</label>
                <br />
            ...
            <br />
            Please
            <a href="https://github.com/alvisxp/kambaz-react-web-app-su1-25" id = "wd-github">
            {' '}
            click here {' '}
            </a>
